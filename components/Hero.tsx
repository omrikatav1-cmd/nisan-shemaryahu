...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      ref={heroRef}
      className="relative min-h-dvh flex flex-col items-center justify-center overflow-hidden pt-24 pb-16 px-4 sm:px-6"
    >
      {/* ─── Background ─────────────────────────────────────────── */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <Orb className="absolute top-1/4 right-1/4 w-[700px] h-[700px] rounded-full bg-[#3B82F6]/6 blur-[160px]" delay={0}   duration={9} />
        <Orb className="absolute bottom-1/4 left-1/3  w-[450px] h-[450px] rounded-full bg-[#D4AF37]/5 blur-[130px]" delay={2.5} duration={11} />
        <Orb className="absolute top-2/3 right-1/6   w-[280px] h-[280px] rounded-full bg-[#3B82F6]/4 blur-[100px]" delay={1.5} duration={7} />
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 glass rounded-full px-5 py-2 text-xs font-bold text-[#D4AF37] mb-8 border border-[#D4AF37]/25"
        >
          <motion.span
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl lg:text-7xl font-black leading-[1.05] mb-10"
        ...
        {/* Sub-copy – page scroll, starts GRAY, fills on scroll */}
        <motion.div
        ...
        >
          <ScrollRevealText
            ...
            className="text-2xl sm:text-3xl font-black leading-relaxed max-w-3xl mx-auto"
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="group inline-flex items-center justify-center gap-2.5 bg-[#3B82F6] hover:bg-[#2563EB] text-white font-black text-base px-8 py-4 rounded-xl transition-colors duration-200 hover:shadow-[0_0_32px_rgba(59,130,246,0.55)] cursor-pointer"
          >
            קבל הצעת מחיר חינם
        ...
        >
          {stats.map(({ icon: Icon, value, label }, idx) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.68 + idx * 0.1, ease: EASE }}
